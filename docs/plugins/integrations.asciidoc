...
* https://github.com/kohesive/elasticsearch-data-import-handler[Kohesive - Elasticsearch Data Import handler]:
  Import from CSV, Parquet, ORC, JDBC databases and other file formats on single machine or scale to a cluster with full power of Spark SQL including joins across data sources. 
